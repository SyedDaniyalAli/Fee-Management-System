...
ResultSet r;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Employee Settings");
    ...
    private void jButton9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton9MouseClicked
       try {
            r=s.executeQuery("select * from employee where Email='"+emailnotice.getText()+"' and Pass ='"+Accountant_login.Epass.getText()+"'");
        
                if(r.next())
                {
                    if(Accountant_login.Epass.getText().equals(oldpass.getText()))
                    {
                        if(newpass.getText().equals(cpass.getText()))
                        {
                          int result=s.executeUpdate("update employee\n" +
                                        "set email='"+emailnotice.getText()+"',\n" +
                                        "Pass='"+newpass.getText()+"'\n" +                                        
                                        "where email='"+emailnotice.getText()+"'");
                    if(result>0)
                    {
            ...
            JOptionPane.showMessageDialog(this,"Please type password to change");
        }
    ...
    private void jButton11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton11MouseClicked
        try {
            r=s.executeQuery("select * from employee where Email='"+emailnotice.getText()+"' and Pass ='"+Accountant_login.Epass.getText()+"'");
                ...
                if(r.next())
                {
                    if(oldsq.getSelectedItem().equals(r.getString(5)))
                    {
                        if(oldsa.getText().equals(r.getString(6)))
                        {
                          int result=s.executeUpdate("update employee\n" +
                                                    "set email='"+emailnotice.getText()+"',\n" +
